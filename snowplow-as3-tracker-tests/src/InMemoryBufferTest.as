...
package
{
    ...
    import com.snowplowanalytics.snowplow.tracker.emitter.InMemoryBuffer;
    ...
    public class InMemoryBufferTest {
        ...
        private var buffer:InMemoryBuffer;
        private var payload:IPayload;
        private var bufferSize:int = 105;

        [Before]
        public function setUp():void {
            this.buffer = new InMemoryBuffer("primaryBuffer", this.bufferSize);
